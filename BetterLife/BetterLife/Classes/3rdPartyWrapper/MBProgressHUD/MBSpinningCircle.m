...
+(MBSpinningCircle*)circleWithSize:(NSSpinningCircleSize)size color:(UIColor*)color
{
  ...
  circle.color = color == nil?[UIColor colorWithRed:50.0/255.0 green:155.0/255.0 blue:255.0/255.0 alpha:1.0]:color;
  circle.autoresizingMask = UIViewAutoresizingFlexibleRightMargin | UIViewAutoresizingFlexibleLeftMargin | UIViewAutoresizingFlexibleTopMargin | UIViewAutoresizingFlexibleBottomMargin;
  circle.hasGlow = YES;
